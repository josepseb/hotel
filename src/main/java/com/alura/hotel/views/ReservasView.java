...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel lblCheckIn = new JLabel("FECHA INGRESO");
		lblCheckIn.setForeground(SystemColor.textInactiveText);
		lblCheckIn.setBounds(68, 136, 169, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);

		JLabel lblCheckOut = new JLabel("FECHA SALIDA");
	...
	private void guardarReserva() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("")
			...
			JOptionPane.showMessageDialog(this, "Llena por favor todos los campos");
		}
	}
	...
	public void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida) {
		if (fechaEntrada.getDate() != null && fechaSalida.getDate() != null) {
			...
			if(fechaEntrada.getDate().after(fechaSalida.getDate())) {
				JOptionPane.showMessageDialog(null, "Fecha entrada no puede ser mayor a salida","Error en fechas",JOptionPane.ERROR_MESSAGE);
				return;
			}
